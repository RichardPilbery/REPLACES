...
We examined whether there was any correlation between respondent's reported value of a CMR referral pathway and respondent demographic details (current role and frequency of operational duties) using ordinal logistic regression to take account of the Likert scoring used.  
